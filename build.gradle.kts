...
description = "Optimized Minecraft Java Client-Base for 1.8.9"
...
dependencies {
    ...
    implementation(group = "com.google.code.gson", name = "gson", version = "2.10.1") // Move to another faster more modern JSON library
